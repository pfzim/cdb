<?php
	...
	/**
		...
		- list   - список данных, описание колонок:
		  ...
		  - port                   - порт коммутатора в который подключено
		                             устройство
		  - SingleCollisionFrames  - коллизии, их появление говорит о том, что
		                             линк работает в полудуплексе, чего быть не
 									 должно
		  - CarrierSenseErrors     - потери несущей, частая их регистрация
                                     (флаппинг) говорит о проблемах с физикой.
									 Порогом для предупреждения принимаем более
									 10 событий в час
		  - InErrors               - сводный показатель количества ошибок
                                     приема. Их быть не должно
	*/

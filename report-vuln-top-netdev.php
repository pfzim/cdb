...
EOT;
	...
	if($db->select_assoc_ex($result, rpv("
		...
		LEFT JOIN @vuln_scans AS vs
			...
			AND vs.`folder_id` = {%NESSUS_NETDEV_FOLDER_ID}
	...
	if(php_mailer(REPORT_VULNS_MAIL_TO, CDB_TITLE.': Detected vulnerabilities - Network devices', $html, 'You client does not support HTML'))
	{
		echo 'Send mail: OK';
	}
	else

...
EOT;
	...
	$html .= '<p>Всего: '.$i.'</p>';
	$html .= $table;
	$html .= '<br /><small>Для перезапуска отчёта:<br />1. <a href="http://web.bristolcapital.ru/cdb/ad-sync.php">Выполнить синхронизацию с AD</a><br />2. <a href="http://web.bristolcapital.ru/cdb/tmao-sync.php">Выполнить синхронизацию с Apex One</a><br />3. <a href="http://web.bristolcapital.ru/cdb/tmee-sync.php">Выполнить синхронизацию с Endpoint Encryption</a><br />4. <a href="http://web.bristolcapital.ru/cdb/create-tasks.php">Сформировать отчёт</a></small>';
	$html .= '</body>';

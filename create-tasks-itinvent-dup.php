			...
			$xml = helpdesk_api_request(
				...
				.'&Message='.helpdesk_message(
					...
					array(
						...
						'data'			=> $message,
						'info'			=> ((intval($row['flags']) & MF_SERIAL_NUM)
							? 'Описание контроля уникальности SN оборудования в ИТ Инвент '.WIKI_URL.'/Процессы%20и%20функции%20ИТ.Описание-контроля-уникальности-SN-оборудования-в-ИТ-Инвент.ashx'
							: 'Описание контроля уникальности MAC адресов оборудования в ИТ Инвент '.WIKI_URL.'/Процессы%20и%20функции%20ИТ.Описание-контроля-уникальности-MAC-адресов-оборудования-в-ИТ-Инвент.ashx'
						)
					)
				)
			);

...
$template_helpdesk_messages = array(
	...
	TT_INV_ADD =>
		...
		."\nВремя регистрации: %regtime%"
		."\n\nКод работ: IIV09"
		."\n\nСледует актуализировать данные по указанному устройству и заполнить соответствующий атрибут. Подробнее: ".WIKI_URL.'%wiki_topic%'
	...
	TT_BRWS_UNINSTALL =>
		'На компьютере обнаружен неподдерживаемый браузер (Firefox или Chrome).'
		."\n\nПК: %host%"
		."\nИсточник информации о ПК: %flags%"
		,
